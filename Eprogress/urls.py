...
from Eprogressapp import views, HodViews, StaffViews, StudentViews
from Eprogressapp.EditResultVIewClass import EditResultViewClass
from Eprogress import settings
